...
기본 지식 (192p) SKIP
- 
### R 제공 그래프 함수 : plot(), barplot(), hist(), boxplot() (193p) SKIP
- 설명~~
...
![](R_9_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-6-2.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-8-2.png)<!-- -->

```r
ggplot(data=diamonds,aes(x=carat)) + geom_histogram(binwidth = 0.01)
```

![](R_9_files/figure-html/unnamed-chunk-8-3.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-11-1.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-11-2.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-11-3.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-11-4.png)<!-- -->


### ggplot() 함수를 정교하게 그리기  (215p)
...
![](R_9_files/figure-html/unnamed-chunk-13-2.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-14-3.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-14-4.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-15-2.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-16-2.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-16-3.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-16-4.png)<!-- -->

2.2. scale_x_discrete(limits=c()) : 그래프 순서를 직접 정하기


2.3. coord_flip() : 막대그래프를 90도 회전해서 수평으로 그리기


2.4. xlim(), ylim() : x축과 y축의 범위 지정하기


2.5. ggtitle(), xlab(), ylab() : 그래프와 축에 이름 붙이기
...
![](R_9_files/figure-html/unnamed-chunk-21-1.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-21-3.png)<!-- -->

```r
ggplot(who_disease,aes(x = year, y = cases)) + geom_point(alpha=0.1, colour="#9FCFE3") #adode 가서 색상 
```

![](R_9_files/figure-html/unnamed-chunk-21-4.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-21-5.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-21-6.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-21-7.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-21-8.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-21-9.png)<!-- -->

1.2. colour 입력 위치 변경해보기
...
![](R_9_files/figure-html/unnamed-chunk-23-2.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-23-3.png)<!-- -->
...
![](R_9_files/figure-html/unnamed-chunk-23-4.png)<!-- -->
